...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 mode=supervised\
 n_csts=16\
 output_folder=/home/users/o/oleksiyu/WORK/hyperproject/user/classifiers_nofold2/super_16cst_$(date +"%Y%m%d%H%M%S")\
 network_name=class_llv_super_16cst_$(date +"%Y%m%d%H%M%S")\
