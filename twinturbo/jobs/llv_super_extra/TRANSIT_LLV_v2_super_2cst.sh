...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 mode=supervised\
 n_csts=4\
 output_folder=/home/users/o/oleksiyu/WORK/hyperproject/user/classifiers_nofold2/super_2cst_$(date +"%Y%m%d%H%M%S")\
 network_name=class_llv_super_2cst_$(date +"%Y%m%d%H%M%S")\
