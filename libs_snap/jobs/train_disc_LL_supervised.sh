...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 /opt/conda/bin/python /home/users/o/oleksiyu/WORK/hyperproject/libs_snap/anomdiff/scripts/train_disc.py mode=supervised\
 output_folder=/home/users/o/oleksiyu/WORK/hyperproject/user/classifiers/supervised"
