...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif bash\
 -c "cd /home/users/o/oleksiyu/WORK/hyperproject/ && python /home/users/o/oleksiyu/WORK/hyperproject/twinturbo/scripts/full_run.py\
 --config-name twinturbo_reco_DisCo_massfromgap_smooth\
 general.subfolder=gauss_corr_4_gap_twinturbo_usem_addgapmass/\
 general.seed=6\
 general.name=twinturbo_reco_DisCo_massfromgap_smooth_s6"
