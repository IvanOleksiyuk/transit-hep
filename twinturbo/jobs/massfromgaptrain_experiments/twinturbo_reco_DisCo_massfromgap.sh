#!/bin/sh
#SBATCH --job-name=twinturbo_reco_DisCo_massfromgap
...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 --config-name twinturbo_reco_DisCo_massfromgap general.subfolder=gauss_corr_4_gap_twinturbo_usem_addgapmass/"
