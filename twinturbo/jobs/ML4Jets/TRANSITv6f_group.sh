#!/bin/sh
#SBATCH --job-name=TRANSITv6f_group
#SBATCH --cpus-per-task=16
#SBATCH --ntasks=1
#SBATCH --time=11:00:00
#SBATCH --partition=shared-gpu,private-dpnc-gpu
#SBATCH --nodes=1
#SBATCH --output=/home/users/o/oleksiyu/WORK/hyperproject/twinturbo/jobs/job_output/TRANSITv6f_group-%A-%x_%a.out
#SBATCH --mem=16GB
#SBATCH --gres=gpu:1
...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 full_run_cfg=TRANSITv6f\
 run_dir=twinturbo/workspaces/ML4Jets/TRANSITv6f_group"
