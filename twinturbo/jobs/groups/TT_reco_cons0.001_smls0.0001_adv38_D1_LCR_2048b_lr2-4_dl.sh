...
#SBATCH --nodes=1
#SBATCH --output=/home/users/o/oleksiyu/WORK/hyperproject/twinturbo/jobs/job_output/TT_reco_cons0.001_smls0.0001_adv38_D1_LCR_2048b_lr2-4_dl-%A-%x_%a.out
#SBATCH --mem=16GB
#SBATCH --gres=gpu:1
...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 run_dir=twinturbo/workspaces/groups/TT_reco_cons0.001_smls0.0001_adv38_D1_LCR_2048b_lr2-4_dl"
