...
#SBATCH --nodes=1
#SBATCH --output=/home/users/o/oleksiyu/WORK/hyperproject/transit/jobs/job_output/CLASS_TRANSIT_LLV_v2_0cst-%A-%x_%a.out
#SBATCH --mem=32GB
#SBATCH --gres=gpu:1
...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 mode=idealised\
 n_csts=1\
 output_folder=/home/users/o/oleksiyu/WORK/hyperproject/user/classifiers_nofold2/ideal_0cst_$(date +"%Y%m%d%H%M%S")\
 network_name=class_llv_ideal_0cst_$(date +"%Y%m%d%H%M%S")\
