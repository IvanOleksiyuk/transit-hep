...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 mode=idealised\
 n_csts=4\
 output_folder=/home/users/o/oleksiyu/WORK/hyperproject/user/classifiers_nofold2/ideal_4cst_$(date +"%Y%m%d%H%M%S")\
 network_name=class_llv_ideal_4cst_$(date +"%Y%m%d%H%M%S")\
