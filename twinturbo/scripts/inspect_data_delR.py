...
@hydra.main(
    version_base=None, config_path=str('../config'), config_name="twinturbo_reco_cons_DisCo_wide_LHCO_raw_nogap_train.yaml"
)
def main(cfg: DictConfig) -> None:
    ...
    data_cfg.plotting_path = "plot/user/inspect_data2/" + dataset_name
