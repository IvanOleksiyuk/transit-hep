#!/bin/sh
#SBATCH --job-name=TRANSIT_LLV_v18_32cst
#SBATCH --cpus-per-task=16
#SBATCH --ntasks=1
#SBATCH --time=11:00:00
#SBATCH --partition=shared-gpu
#SBATCH --nodes=1
#SBATCH --output=/home/users/o/oleksiyu/WORK/hyperproject/twinturbo/jobs/job_output/TRANSIT_LLV_v18_32cst-%A-%x_%a.out
#SBATCH --mem=32GB
#SBATCH --gres=gpu:1
...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 --config-name TRANSIT_LLV_v18_32cst general.subfolder=TRANSIT_LLV/\
