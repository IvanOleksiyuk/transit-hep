...
&& python /home/users/o/oleksiyu/WORK/hyperproject/twinturbo/scripts/full_run.py --config-name twinturbo_reco_only_nom data=gauss_sph_4_twinturbo_usem general.subfolder=gauss_sph_4_twinturbo_usem/ do_train_template=0 do_export_template=0\
