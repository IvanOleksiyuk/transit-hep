...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 mode=supervised\
 n_csts=128\
 output_folder=/home/users/o/oleksiyu/WORK/hyperproject/user/classifiers_nofold2/super_128cst_$(date +"%Y%m%d%H%M%S")\
 network_name=class_llv_super_128cst_$(date +"%Y%m%d%H%M%S")\
