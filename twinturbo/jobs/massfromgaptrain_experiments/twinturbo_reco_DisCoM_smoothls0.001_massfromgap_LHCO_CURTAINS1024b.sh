#!/bin/sh
#SBATCH --job-name=twinturbo_reco_DisCoM_smoothls0.001_massfromgap_LHCO_CURTAINS1024b
#SBATCH --cpus-per-task=16
#SBATCH --ntasks=1
#SBATCH --time=2:00:00
#SBATCH --partition=shared-gpu,private-dpnc-gpu
#SBATCH --nodes=1
#SBATCH --output=/home/users/o/oleksiyu/WORK/hyperproject/twinturbo/jobs/job_output/twinturbo_reco_DisCoM_smoothls0.001_massfromgap_LHCO_CURTAINS1024b-%A-%x_%a.out
#SBATCH --mem=16GB
#SBATCH --gres=gpu:1
...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 --config-name twinturbo_reco_DisCoM_smoothls0.001_massfromgap_LHCO_CURTAINS1024b\
