#!/bin/sh
#SBATCH --job-name=TRANSITv1_HLV
#SBATCH --cpus-per-task=16
#SBATCH --ntasks=1
#SBATCH --time=5:00:00
#SBATCH --partition=shared-gpu,private-dpnc-gpu
#SBATCH --nodes=1
#SBATCH --output=/home/users/o/oleksiyu/WORK/hyperproject/twinturbo/jobs/job_output/TRANSITv1_HLV-%A-%x_%a.out
#SBATCH --mem=16GB
#SBATCH --gres=gpu:1
...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 --config-name TRANSITv1_HLV general.subfolder=2024_09_09/\
