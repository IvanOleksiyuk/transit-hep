#!/bin/sh
#SBATCH --job-name=twinturbo_reco_DisCo_massfromgap_smooth0.002elu_LHCO_CURTAINS1024b
#SBATCH --cpus-per-task=16
#SBATCH --ntasks=1
#SBATCH --time=4:00:00
#SBATCH --partition=shared-gpu,private-dpnc-gpu
#SBATCH --nodes=1
#SBATCH --output=/home/users/o/oleksiyu/WORK/hyperproject/twinturbo/jobs/job_output/twinturbo_reco_DisCo_massfromgap_smooth0.002elu_LHCO_CURTAINS1024b-%A-%x_%a.out
#SBATCH --mem=16G
#SBATCH --gres=gpu:1
