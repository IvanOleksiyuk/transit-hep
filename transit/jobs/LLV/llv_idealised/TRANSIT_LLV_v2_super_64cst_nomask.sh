...
singularity exec --nv -B /home/users/,/srv,/tmp hyperproject_container.sif \
 ...
 --config-name=train_disc_nomask.yaml\
 mode=idealised\
 n_csts=64\
 output_folder=/home/users/o/oleksiyu/WORK/hyperproject/user/classifiers_nofold2/super_64cst_nomask_$(date +"%Y%m%d%H%M%S")\
 network_name=class_llv_super_64cst_nomask_$(date +"%Y%m%d%H%M%S")\
