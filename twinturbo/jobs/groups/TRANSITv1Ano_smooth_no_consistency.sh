#!/bin/sh
#SBATCH --job-name=TRANSITv1Ano_smooth_no_consistency
#SBATCH --cpus-per-task=16
#SBATCH --ntasks=1
#SBATCH --time=10:00:00
#SBATCH --partition=shared-gpu,private-dpnc-gpu
#SBATCH --nodes=1
#SBATCH --output=/home/users/o/oleksiyu/WORK/hyperproject/twinturbo/jobs/job_output/TRANSITv1Ano_smooth_no_consistency-%A-%x_%a.out
#SBATCH --mem=16GB
#SBATCH --gres=gpu:1
